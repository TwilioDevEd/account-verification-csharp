...
namespace AccountVerification.Web.Tests
{
    public class TestUserStore : IUserStore<ApplicationUser>, IUserLoginStore<ApplicationUser>, IUserRoleStore<ApplicationUser>, IUserClaimStore<ApplicationUser>, IUserPasswordStore<ApplicationUser>, IUserSecurityStampStore<ApplicationUser>
    {
        ...
        public TestUserStore()
        {
            ...
            {
                { "TestUser1", new ApplicationUser {Name="Sharon", Email= "sharon@email.com",
                    UserName = "sharon@email.com", Id="15e8cda1-3ea3-473d-902f-b62aa55816db"}},
                { "TestUser2", new ApplicationUser {Name="adarsh", Email="adarsh@email.com",
                    UserName = "adarsh@email.com", Id="67e6yda1-3ea3-473d-902f-b62er55816db"}},
                { "TestUser3", new ApplicationUser {Name="Shiju",  Email="shiju@email.com",
